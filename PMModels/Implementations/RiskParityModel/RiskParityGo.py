...
'''===================================================================================================
File content:
the wrapped class of the RiskParity model, the GUI, the model that computing the weights and graphs, etc
==================================================================================================='''

class RiskParityGo(UI_MainWindow):
	'''==============================================================================================
	Members:
	...
	runner()		-- run RiskParity model and return weights and graphs
	=============================================================================================='''
	def __init__(self):
		init_dict = {'window title':'RiskParityGo', 'window width': 3*550, 'window height': 550}
		super(RiskParityGo, self).__init__(init_dict)
		self._weights = [];

		self._comboBox_ls = {}
		self._comboBox_ls['comboBox_1'] = ['5/1/2018', '5/30/2008', '6/9/2008'];
	...
	def runner(self):
		...
		res = RiskParity_model(init_dict);
